...
# Главное меню
btn_1 = InlineKeyboardButton('📚 Каталог', callback_data='pre_filters')
...
btn_back = InlineKeyboardButton('🔙 Меню', callback_data='back_to_main')
...
back_btn = InlineKeyboardButton('◀ Назад', callback_data='prev_wallpaper')
next_btn = InlineKeyboardButton('Вперед ▶', callback_data='next_wallpaper')
...
#Кнопки фильтра
filtr_btn = InlineKeyboardButton('⚙ Фильтры', callback_data='filters')
apply_btn = InlineKeyboardButton('🔎 Применить', callback_data='catalog')
filters_keyboard = InlineKeyboardMarkup(row_width=1).add(filtr_btn, apply_btn, btn_back)

filter_back = InlineKeyboardButton('🔙 Обратно', callback_data='back_to_filter')
